...
static int8_t STREAM_SC_CU_TransmitCplt(uint8_t* pbuf, uint32_t* Len, uint8_t epnum);
...
static int8_t STREAM_SC_CU_TransmitCplt(uint8_t* Buf, uint32_t* Len, uint8_t epnum)
{
    UNUSED(Buf);
    UNUSED(Len);
    UNUSED(epnum);
